...
public class SanctionOtherGUI extends AbstractGui {

    private String targetName;

    public SanctionOtherGUI(MoonBukkitCore plugin, String target) {
        super(plugin);
        this.targetName = target;
    }

    public void display(Player player) {
        this.inventory = plugin.getServer().createInventory(null, 54, "Infraction (autre)");
        ...
        SanctionList.get(SanctionStatus.AUTRE).forEach(sanction -> {
            double multiplier;
