...
public class ThunderCommand implements CommandExecutor
{
	...
	private String syntax = "/thunder";
	
	public ThunderCommand(MoonBukkitCore plugin)
	{
		this.plugin = plugin;
	...
	public boolean onCommand(CommandSender sender, Command command, String s, String[] args)
	{
		if (sender instanceof Player)
		{
			CustomPlayer customPlayer =
					persistanceManager.getPlayerManager().getCustomPlayer(RedisKey.PLAYER, ((Player) sender).getUniqueId());
